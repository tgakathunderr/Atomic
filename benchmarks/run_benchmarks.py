...
> **Analysis**: Both models perform poorly on MQAR at this scale and training duration ({recall_results['atomic_acc']*100:.1f}% vs {recall_results['transformer_acc']*100:.1f}%, near-random baseline for this task). Associative recall capacity and multi-query retrieval at tiny parameter budgets (<10M) remain an open limitation for both architectures.
"""
